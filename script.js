...
window.addEventListener("load", () => {
  ...
  const statements = [
    ...
    "In Sri Lanka, cardiovascular disease claims over 90 lives every day—adding up to more than 33,000 deaths in 2020.",
  ...
  const holdDuration = 1.0; // Time statement is fully visible (1 unit of scroll distance)
